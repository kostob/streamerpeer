...
struct output_interface {
    ...
    int (*deliver_encryption_data_chunk)(struct output_context *context, struct chunk *secureData);
    int (*deliver_encryption_data_login)(struct output_context *context, struct chunk *secureData);
